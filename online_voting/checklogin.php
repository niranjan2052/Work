  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="nospace inline pushright">
        ...
        <li><i class="fa fa-envelope-o"></i> niranjankpatel52@gmail.com </li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.php">E-VOTING</a></h1>
    </div>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/background1.jpg');">
  <section id="testimonials" class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <h2 class="font-x3 uppercase btmspace-80 underlined"> E <a href="#">Voting</a></h2>
  ...
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        ...
        <li><i class="fa fa-phone"></i> +9771773254014<br>
          +9771521479574</li>
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        ...
        <li><i class="fa fa-envelope-o"></i> niranjankpate52@gmail.com </li>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright &copy; 2017 - All Rights Reserved - <a href="#">Niranjan Kr.Patel</a></p>
